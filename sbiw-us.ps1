...
Write-Host "Choose dependencies (separate with commas, e.g., 1,2,3):"
Write-Host "1. web"
...
Write-Host ""
Write-Host "You have chosen the following options:"
